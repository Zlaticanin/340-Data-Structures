...
* Prepare your Makefile (**you need to construct and add Makefile**) so that the TA only needs to invoke the command `make` to compile your source file and produce the executable file `sieve.exe`.  Make sure you use exactly the same file names specified here, i.e. `sieve.cc` and `sieve.exe`, in your `Makefile`. Otherwise your submission will get 0 points.
